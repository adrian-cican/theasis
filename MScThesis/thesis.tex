...
%%----------------------------------------
\title{Predictive Maintenance and Anomaly Detection Algorithm for Biomethane Plants}
\author{Mihai Adrian Cican}
...
\supervisor{Supervisor}{Gil Manuel Gonçalves}

%% Uncomment next line if necessary
\supervisor{Second Supervisor}{Eliseu Pereira}
\supervisor{Second Supervisor}{João Reis}
